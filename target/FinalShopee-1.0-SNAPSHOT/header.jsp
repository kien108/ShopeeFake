        ...
        <header class="header">
            <div class="container">
                <nav class="header__navbar hide-on-mobile-tablet">
                    ...
                    <ul class="header__navbar-list">
                        ...
                        <c:choose>
                            ...
                            <c:otherwise>
                                <li class="header__navbar-item header__navbar-item--strong header__navbar-item--separate-strong js-sign-up">
                                    <a href="Register.jsp" class="header__navbar-item-link">Đăng ký</a></li>
                ...
                <div class="header-with-search">
                    <label for="" class="header__mobile-search">
                        <i class="header__mobile-search-icon fas fa-search"></i>
                    </label>

                    <div class="header__logo hide-on-tablet">
                        <a href="home-products" class="header__logo-link">
                    ...
                    <input type="checkbox" class="header__search-checkbox"  hidden >
                    <form class="header__search" method="post" action="home-products">
                        <input type="hidden" name="csrfToken" value="<%= csrfToken %>"/>
                        <div class="header__search-input-wrap">
                            <input pattern="[A-Za-z0-9]+" name="searchString" type="text" autocomplete="off" class="header__search-input" placeholder="Nhập để tìm kiếm sản phẩm" >
                            <div class="header__search-history">
                                <h3 class="header__search-history-heading">Lịch sử tìm kiếm</h3>
                                <ul class="header__search-history-list">
                                    <li class="header__search-history-item">
                                        <a href="">Tai nghe apple</a>
                                    </li>
                                    <li class="header__search-history-item">
                                        <a href="">Tai nghe quẩy vinahouse</a>
                                    </li>
                                    <li class="header__search-history-item">
                                        <a href="">Tai nghe hiệu Khá Bảnh</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                            ...
                            <div class="header__cart-wrap">
                                <i class="header__cart-icon fas fa-shopping-cart"></i>
                                    ...
                                    <c:choose>
                                        ...
                                        <c:when test="${sessionScope.cart.quantity == 0}">
                                            <span class="header__cart-number">0</span>
                                            <div style="width: 400px; height: 330px" class="header__cart-list">
                                                <!-- No cart: header__cart-list--no-cart -->
                                                <img src="" alt="" class="header__no-cart-img">
                                        ...
                                        <c:otherwise>
                                            <span class="header__cart-number">${sessionScope.cart.listLineItem.size()}</span>
                                            <div class="header__cart-list">
                                                ...
                                                <ul class="header__cart-list-items">
                                                    ...
                                                    <c:forEach items="${sessionScope.cart.listLineItem}" var="o">
                                                        <li class="header__cart-item">
                                                            <img src="${o.product.listImg.get(0).piUrl}" alt="" class="header__cart-img">
                                                            <div class="header__cart-item-info">
                                                                <div class="header__cart-item-head">
                                                                    <h5 class="header__cart-item-name">${o.product.title}</h5>
                                                                    <div class="header__cart-item-price-wrap">
                                                                        <span class="header__cart-item-price">${o.product.FormatPrice()}</span>
                                                                        <span class="header__cart-item-multiply">x</span>
                                                                        <span class="header__cart-item-quantity">${o.quantity}</span>
                                                                    </div>
                                                                </div>
                                                                <div class="header__cart-item-body">
                                                    <span class="header__cart-item-desc">
                                                        Hãng: ${o.product.manufacturer.name}
                                                    </span>
                                                ...
                                                <a style = "line-height: 34px" href="cart" class="header__cart-view btn btn--primary">Xem giỏ hàng</a>
                                            </div>
                                        </c:otherwise>
                                    </c:choose>
                            </div>
