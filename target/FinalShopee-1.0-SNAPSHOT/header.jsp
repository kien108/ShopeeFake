        ...
        <header class="header">
            <div class="container">
                ...
                <div class="header-with-search">
                    ...
                    <form class="header__search" method="get" action="home-products">
                        <div class="header__search-input-wrap">
                            <input name="searchString" type="text" autocomplete="off" class="header__search-input" placeholder="Nhập để tìm kiếm sản phẩm" >
